...
export default function Home() {
  ...
  const thunderBtn = <div className='py-[10px] px-4 text-meliBlue bg-meliBgDefault rounded-[26px] flex justify-center items-center gap-2'>
    <ThunderIcon />
  ...
  const saleBtn = (
    <div className='py-[18px] px-4 text-meliBgDefault bg-meliBlue rounded-[26px] flex justify-center items-center'>
    ...
    <section className="flex items-center text-center bg-meliBgPrimary">
      <Container>
        <div className='flex flex-col justify-center'>
          ...
          <p className="text-meliBlue font-semibold text-xs mt-3">
      ...
      <Container className='grid grid-cols-1 md:grid-cols-3 lg:grid-cols-6 gap-4 mt-8 '>
        {infoCards.map((card, index) => (
          <div key={index} className="bg-white p-4 rounded-lg shadow-md">
            ...
            <div className="text-meliDark mt-12 mb-7 flex justify-center text-meliBlue h-[60px] items-center">{card.icon}</div>
            <p className="text-sm text-meliGray mt-1 text-center">{card.description}</p>
            <button className="text-meliBlue font-semibold mt-3">{card.button}</button>
          </div>
        ))}
      </Container>
    </section>
